...
(function (HR) {
  ...
  const ENTRIES = [
    ...
    {
      version: '2026.9.78', date: '2026-09-11',
      changes: ['Overview: the department × entitlement-category heatmap spans the page; it was cropped in half a row.']
    },
    {
    ...
    {
      version: '2026.9.68', date: '2026-09-11',
      changes: ['Scorecards by theme, under the frameworks: Identity, Joiners / movers / leavers, Privileged access, Access hygiene, Licences and cost, HelloID operations — each the question a reader asks, cutting across frameworks, with the same ring, bars and drill-down to its KPIs (theme chips on The KPIs too). The ring is a thinner band with the numbers well inside it; they touched the stroke.']
    },
    {
    ...
    {
      version: '2026.9.57', date: '2026-09-08',
      changes: ['Organisation › Data quality answers “who?”: a job-title row opens the people who carry it (active and ended), an attribute row opens the people who lack it, each row opening the person.']
    },
    {
    ...
    {
      version: '2026.9.53', date: '2026-09-08',
      changes: [
    ...
    {
      version: '2026.9.52', date: '2026-09-08',
      changes: [
